...
import otkankunlar1 from './audio/otkankunlar2.mp3'
import dunyoningishlari1 from './audio/dunyoningishlari.mp3'
import kechavakunduz1 from './audio/kechavakunduz1.mp3'
import ulugbekxazinasi1 from './audio/ulugbekxazinasi.mp3'
import mexrobdanchayon1 from './audio/mexrobdanchayon1.mp3'
import otkankunlar2 from './audio/mexrobdanchayon2.mp3'
import dunyoningishlari2 from './audio/mexrobdanchayon2.mp3'
import kechavakunduz2 from './audio/mexrobdanchayon2.mp3'
import ulugbekxazinasi2 from './audio/mexrobdanchayon2.mp3'
import mexrobdanchayon2 from './audio/mexrobdanchayon2.mp3'
    ...
    const data = [
        {
            ...
            parts: [
                { audio: otkankunlar1, title: "Part 1" },
                { audio: otkankunlar2, title: "Part 2" },
            ],
        },
        {
